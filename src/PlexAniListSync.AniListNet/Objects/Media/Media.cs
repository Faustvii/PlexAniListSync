...
public class Media
{
    ...
    /// </summary>
    [GqlSelection("title")]
    public MediaTitle Title { get; private set; } = null!;
    ...
    /// </summary>
    [GqlSelection("startDate")]
    public Date StartDate { get; private set; } = null!;

    /// <summary>
    /// The last official release date of the media.
    /// </summary>
    [GqlSelection("endDate")]
    public Date EndDate { get; private set; } = null!;

    /// <summary>
    /// The season the media was initially released in.
    /// </summary>
    [GqlSelection("season")]
    public MediaSeason? Season { get; private set; }

    /// <summary>
    /// The season year the media was initially released in.
    /// </summary>
    [GqlSelection("seasonYear")]
    public int? SeasonYear { get; private set; }

    /// <summary>
    /// The amount of episodes the anime has when complete.
    /// </summary>
    [GqlSelection("episodes")]
    ...
    /// </summary>
    [GqlSelection("coverImage")]
    public MediaCover Cover { get; private set; } = null!;
    ...
    /// </summary>
    [GqlSelection("genres")]
    public string[] Genres { get; private set; } = Array.Empty<string>();

    /// <summary>
    /// Alternative titles of the media.
    /// </summary>
    [GqlSelection("synonyms")]
    ...
    /// </summary>
    /// <remarks>Requires user authentication with AniList!</remarks>
    [GqlSelection("mediaListEntry")]
    public MediaEntrySub? Entry { get; private set; }
}
