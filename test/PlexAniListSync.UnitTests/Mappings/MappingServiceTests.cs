...
public class MappingServiceTests
{
        ...
        dataCache
            ...
            .Returns(
                new List<AnilistMapping>()
                {
                    ...
                    {
                        Title = "MyTitle",
                        LookupIds = new[] { "MyTitle" },
                        Seasons = seasons
                    }
                }
            );
        var service = new MappingService(dataCache.Object);
        var id = service.GetAniListIdFromPlexGuid("MyTitle", seasonNumber, episode);
    ...
    [InlineData(
        1,
        "plex://show/5e7362fb4a62f90040e89827",
        "86: Eighty Six",
        new[] { "86", "Eighty Six", "plex://show/5e7362fb4a62f90040e89827" }
    )]
    ...
    public void Can_Find_Show_From_LookupIds(int expectedId, string query, string title, string[] lookupIds)
    {
        var dataCache = new Mock<IDataCache>();
        dataCache
            .Setup(x => x.GetAnilistMapping())
        ...
        var service = new MappingService(dataCache.Object);
        var id = service.GetAniListIdFromPlexGuid(query, 1, 1);
        Assert.Equal(expectedId, id);
    }
    ...
    public static class MappingServiceTestData
    {
        ...
        private static readonly object[] s_testTwo = new object[] { 100, 1, 11, MultipleSeasonData };

        private static readonly object[] s_testThree = new object[] { 101, 1, 12, MultipleSeasonData };

        private static readonly object[] s_testFour = new object[] { 102, 2, 12, MultipleSeasonData };
